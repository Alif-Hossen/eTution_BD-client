    ...
    return (
        <div className=' max-w-[1400px] mx-auto'>
            ...
            <div className='grid xl:grid-cols-3  gap-4'>
                <div className='flex flex-col border py-4 px-4 rounded-2xl'>
                    <img className='h-[300px] items-center justify-center' src={homeStudy} alt="" />
                    <div>
                        <h1 className='text-center text-2xl font-bold '>Home Tutoring</h1>
                ...
                <div className='flex flex-col border py-4 px-4 rounded-2xl'>
                    <img className='h-[300px] items-center' src={onlineStudy} alt="" />
                    <div>
                        <h1 className='text-center text-2xl font-bold '>Online Tutoring</h1>
                ...
                <div className='flex flex-col border py-4 px-4 rounded-2xl'>
                    <img className='h-[300px]' src={groupStudy} alt="" />
                    <div>
                        <h1 className='text-center text-2xl font-bold '>Group Tutoring</h1>
